...
export default function EmployeeLifecyclePage() {
    ...
    useEffect(() => {
        Promise.all([
            ...
            fetch(`/api/employee/${params.id}/lifecycle`)
                .then((r) => r.json())
                .catch(() => []),
            fetch(`/api/hr/contracts?employeeId=${params.id}`).then((r) =>
                r.json()
            ),
        ])
            .then(([emps, evts, cts]) => {
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 flex justify-between items-center mb-6">
                    ...
                    <div className="flex gap-2">
                        <button
                            className="px-4 py-2 bg-white border rounded hover:bg-gray-50 flex gap-2"
                        >
                        ...
                        <button
                            ...
                            className="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 flex gap-2"
                        >
                            ...
                            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-5">
                                ...
                                <div className="space-y-3">
                                    {historicalContracts.map((c) => (
                                        <div
                                            key={c.id}
                                            className="text-sm bg-gray-50 p-2 rounded border border-gray-100 flex justify-between items-center"
                                        >
                                            <div>
